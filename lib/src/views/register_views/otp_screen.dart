  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("OTP",
        style: secondaryFont.copyWith(fontSize: 26,fontWeight: FontWeight.w600,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text("9876543218",
              textAlign: TextAlign.center,
              style: secondaryFont.copyWith(fontSize: 16,fontWeight: FontWeight.w600,
              color: const Color(0xff023047),)),
              const Image(image: AssetImage("assets/icons/Group 1787.png")),
            ],
          ),
