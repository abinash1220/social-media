...
class EditScreen extends StatefulWidget {
  ...
  EditScreen({super.key, required this.getPostsData});

  @override
  State<EditScreen> createState() => _CreateScreenState();
}

class _CreateScreenState extends State<EditScreen> {
  ...
  setValues() {
    titleTextController.text = widget.getPostsData.title;
    contentTextController.text = widget.getPostsData.content;
  }
                        ...
                        onTap: () {
                          if (titleTextController.text.isEmpty) {
                            ...
                            postController.editPost(
                                postId: widget.getPostsData.id,
                                title: titleTextController.text,
                                description: contentTextController.text,
                                tags: tags,
                                status: widget.getPostsData.status,
                                date:
                                    "${_date2.year}-${_date2.month}-${_date2.day}",
                                media: selectedImage == null ? null : File(selectedImage));
                          }
                        },
                        child: Container(
                          height: 36,
