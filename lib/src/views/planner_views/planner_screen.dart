  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        body: GetBuilder<PlannersController>(
          builder: (_) {
            return Column(
              children: [
                Padding(
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            width: 107,
                            decoration: BoxDecoration(
                              color:plannerController.index == 0 ? secondaryColor : const Color(0xffE4E4E4),
                              borderRadius: BorderRadius.circular(13),
                            ),
                            child: Center(
                              child: Text("Calendar",
                              style: primaryFont.copyWith(fontSize: 11,
                              color:plannerController.index == 0 ? const Color(0xffF9FAFC) : const Color(0xff023047))),
                            ),
                          ),
                        ),
                        InkWell(
                          ...
                          child: Container(
                            ...
                            width: 107,
                            decoration: BoxDecoration(
                              color: plannerController.index == 1 ? secondaryColor : const Color(0xffE4E4E4),
                              borderRadius: BorderRadius.circular(13),
                            ),
                            child: Row(
                              ...
                              children: [
                                Text("Schedule",
                                style: primaryFont.copyWith(fontSize: 11,
                                color:plannerController.index == 1 ? const Color(0xffF9FAFC) : const Color(0xff023047))),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            width: 107,
                            decoration: BoxDecoration(
                              color: plannerController.index == 2 ? secondaryColor : const Color(0xffE4E4E4),
                              borderRadius: BorderRadius.circular(13),
                            ),
                            child:Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text("Draft",
                                style: primaryFont.copyWith(fontSize: 11,
                                color:plannerController.index == 2 ? const Color(0xffF9FAFC) : const Color(0xff023047))),
                                const SizedBox(width: 5,),
                                Container(
                            height: 14,
                            width: 14,
               ...
               // Image(image: AssetImage("assets/images/Group 1788.png")),
                ...
                const SizedBox(height: 30,),
                if(plannerController.index.value == 1)
                 const ScheduleScreen(),
                if(plannerController.index.value == 2)
                const DraftScreen(),
              ],
            );
          }
