...
import 'package:social_media_marketing/src/services/netwrok_apis/auth_api_services/change_password_api_services.dart';
...
class ProfileController extends GetxController {
  ...
  //create support
  CreateSupportApiServices createSupportApiServices =
      CreateSupportApiServices();
  ...
  createSupport({
    ...
    loder(true);
    dio.Response<dynamic> response = await createSupportApiServices
        .createSupportApiServices(title: title, content: content, image: image);
    loder(false);
  ...
  UserNameUpdateApiServices userNameUpdateApiServices =
      UserNameUpdateApiServices();

  updateName({required String name}) async {
    dio.Response<dynamic> response =
        await userNameUpdateApiServices.userNameUpdateApiServices(name: name);
  ...
  UserProfileImageUpdateApiServices userProfileImageUpdateApiServices =
      UserProfileImageUpdateApiServices();

  updateImage({
    required dynamic image,
  }) async {
    dio.Response<dynamic> response = await userProfileImageUpdateApiServices
        .userProfileImageUpdateApiServices(image: image);
  ...
  changePassword(
      {required String newPassword, required dynamic oldPassword}) async {
    dio.Response<dynamic> response = await changePasswordApiServices
